...
Because most domesticates show reduced genetic diversity relative to their wild counterparts, effort has been made to identify agronomically useful variation in crop wild relatives \citep{flint2009wide}. Often, after identification, the alleles conferring these beneficial traits are bred into domesticates for crop improvement. For example, \emph{Oryza rufipogon}, the wild progenitor of domesticated rice, has proven useful for the integration of a number of beneficial QTL controlling traits such as grain size and yield into domesticated rice \citep{KovackMcCouch2008}. In addition to researching the role of wild alleles in domesticates, researchers have also investigated the role of variation in domesticated taxa in the evolution of feral and weedy populations \citep{ellstrand2010crops}. A recent paper examining the genomic changes associated with rabbit domestication found that many domestication phenotypes are due to mutations in many small effect loci, and that many of these mutations are still found segregating in natural populations of wild rabbit, suggesting that selection acting on standing variation \citep{Rabbit}. There are numerous examples of weedy plants evolving to mimic their domestic counterpart, and even some instances where weedy plants have evolved domesticates (reviewed in \citealt{ellstrand2010crops}). But even though domesticated alleles are often found segregating in wild relatives \citep{Gallavotti2004, SigmonVollbrecht2010}, we know almost nothing about the ecological role of this variation in natural populations. In this paper we present an ecological genetic analysis of the domestication locus \emph{tb1} in natural populations of the wild ancestor of domesticated maize. 
...
\jri{do we mention photoperiod as a possible explanation for phenotyping 1 results?} \mbh{I don't think so...since phenotyping 1 and phenotyping 2 occurred at different times in the year and showed similar results}
...
=======
In contrast to domesticated maize, the \emph{Hopscotch} insertion does not appear to have a large effect on tillering in a diverse sample of \emph{parviglumis} from a natural population and the phenotypic consequences of variation at \emph{tb1} thus remain unclear. Future studies should examine expression levels of \emph{tb1} in teosinte with and without the \emph{Hopscotch} insertion and further characterize the effects of additional loci involved in branching architecture (e.g. \emph{gt1}, \emph{tru1}, and \emph{te1}).  These data, in conjunction with more exhaustive phenotyping, should help reveal the ecological significance of the domesticated \emph{tb1} allele in natural populations of teosinte.
>>>>>>> FETCH_HEAD
