...
We would like to thank the Department of Plant Sciences at UC Davis for Graduate Student Research funding to LEV, \lev{Matt UC Mexus}, and G. Coop for helpful discussion.
...
\lev{So the citations are showing up as ?'s now}
...
\lev{I think we're done with text. What I am having trouble with is the pdf converstion -- was working fine up until a few hours ago, and I don't think I changed any of the '\usepackage' stuff. I've tried in both LaTexian and TexShop and neither works. Also the references have started showing up as question marks.}
