...
The \emph{Hopscotch} allele is more prevalent in \emph{parviglumis} than in \emph{mexicana} in our sample (Appendix 1, See Supplemental Materials with the online version of this article), suggesting a different history of the allele amongst teosinte subspecies.
...
\begin{figure*}[!t]
\begin{center}
   \includegraphics[width=0.6\textwidth]{Fig1MapBalsas.pdf}
   \end{center}
...
\begin{figure*}[!t]
  \begin{center}
   \includegraphics[width=90mm]{Figure4BoxplotPheno1.pdf}
   \end{center}
