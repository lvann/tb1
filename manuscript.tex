...
\subsection*{Genotyping Analysis} \jri{please drop scripts for bayenv and STRUCTURE into github} \lev{which scripts are you talking about? I used matt's for making structure chunks, and then just command line to run structure, same with BayEnv -- it was Tanjas covariance matrix and then just the basic bayenv commands}
