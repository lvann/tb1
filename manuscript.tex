...
\begin{center}
   ...
   \end{center}
    \caption{Map showing the frequency of the \emph{Hopscotch} allele in populations of \emph{parviglumis} where we sampled more than 6 individuals. Size of circles reflects number of individuals sampled. The four Jalisco populations are labeled: San Lorenzo (SLO), La Mesa (MSA), Ejutla A (EjuA), and Ejutla B (EjuB0. The Balsas River is shown, as the Balsas River Basin is believed to be the center of domestication of maize.} 
\label{Fig1Map}
\end{figure*}
%--------------------------------------------
\clearpage
