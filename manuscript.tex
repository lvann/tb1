...
Many of our populations with a high frequency of the \emph{Hopscotch} allele fall in the Jalisco cluster of \emph{parviglumis} identified by \citet{Fukunaga2005}, perhaps suggesting a different history of the \emph{tb1} locus in this region than in the Balsas River Basin where maize was domesticated \citep{Matsuoka2002}. Potential explanations for the high frequency of the \emph{Hopscotch} element in \emph{parviglumis} from the Jalisco cluster include gene flow from maize, genetic drift, and natural selection. 
