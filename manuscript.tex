...
\rowcolors{2}{gray!25}{white}
  ...
  \caption{Pairwise F\textsubscript{ST} values from sequence and \emph{Hopscotch} genotyping data}
    ...
    \multicolumn{1}{c}{\textbf{Comparison}} & \textbf{Seq. Region 2} & \textbf{Seq.  Region 1} & \textbf{\emph{Hopscotch}} \\\midrule
    EjuA \& EJuB & 0     & 0     & 0 \\
    EjuA \& MSA & 0.328 & 0.326 & 0.186 \\
    EjuA \& SLO & 0.258 & 0.416 & 0.28 \\
    EjuB \& MSA & 0.365 & 0.397 & 0.188 \\
    EjuB \& SLO & 0.29  & 0.512 & 0.28 \\
    MSA \& SLO & 0     & 0.007 & 0.016 \\\bottomrule
    \end{tabular}
  \label{Table1Fst}
\end{table}
