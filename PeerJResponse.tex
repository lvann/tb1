...
\res{We are referring to Table S1 and Table S2. We have edited our reference to the tables to be more clear, page 8, lines 209-210: ``The genotype at the \emph{Hopscotch} insertion was confirmed with two PCRs for 837 individuals of the 1,100 screened (Table S1 and Table S2, See Supplemental Materials with the online version of this article)."}

8) Line 150. Why were only 100 bootstrap replicates used for the NJ analysis? 1000 is more typical.\\

\res{We actually conducted our NJ analysis with 10,000 bootstrap replicates and mistakenly reported 100 replicates.  This is clear based on our bootstrap support values which are reported to two decimal places.  We have corrected this typo.}
...
\res{We have determined significance of the Tajima's D results by comparing our empirical values to coalescent simulations generated using the program ms \citep{Hudson2002}.  We describe these methods and results on page 7, lines 157-161 and page 13, lines 368-369.  Significant values are now marked with an asterisk in Table 2}
...
\res{Please see our response to item 14.}
