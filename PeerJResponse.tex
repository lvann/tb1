...
\res{We feel that the addition of state lines makes the figure too busy and difficult to read. However, we have added labels to the 4 Jalisco populations (La Mesa (MSA), San Lorenzo (SLO), Ejutla A (EjuA), and Ejutla B (EjuB)).}
