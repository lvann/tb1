...
\begin{figure*}[!t]
  \begin{center}
   \includegraphics[width=100mm]{FigS2GelPeerJ.png}
   \flushleft{Figure S2: Agarose gel image of amplification products using our primer sets. Genotypes are indicated at the top of the gel.} 
  \end{center}
\end{figure*}
%-------------------------------------------------------------------
