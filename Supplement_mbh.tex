...
\begin{figure*}[!t]
  \begin{center}
   \includegraphics[width=100mm]{FigS3NJtrees.pdf}
...
\begin{table}[htbp]
  \centering
  \caption{Variables and rotations used for the 6 principal components used for BayEnv calculations and their corresponding Bayes Factors}
...
\begin{table}[htbp]
  ...
  \caption{Diversity in the \emph{tb1} region based on the maize SNP50 genotyping data}
    \begin{tabular}{ccccc}\\
    \textbf{Population} & \textbf{\# Seg Sites} & \textbf{$\hat\theta_\pi)$ / bp} & \textbf{$\hat\theta_W$ / bp} & \textbf{Tajima's D} \\
    \midrule
