...
\begin{longtable}{ccp{5cm}cp{5cm}ccc}
...
\hline
 \textbf{Accession} & \textbf{USDA ID} & \textbf{Locality} & \textbf{Number Alleles Sampled} & \textbf{\emph{Hopscotch} Frequency} & \textbf{No \emph{Hopscotch} Frequency} \\\toprule
\endhead
\hline
