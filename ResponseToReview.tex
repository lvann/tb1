...
\res{We have reported sample size information for all three genotypes on page \mbh{X} lines \mbh{XX}. We have also corrected our typo for sample size and the Results and Methods sections are now consistent.} \jri{I didn't see sample sizes for each of the genotpyes. are they there? if not, please add.}
