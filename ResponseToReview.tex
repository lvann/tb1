...
\res{While the recombination landscape will vary to some extent across individuals of teosinte and maize, broad-scale patterns are conserved.  Previous estimates of the decay of linkage disequilibrium based on data from 102 lines of maize suggest LD (as measured by $r^2$) will decline to 0.1 within 2,000 bp \citep{remington2001}}.
