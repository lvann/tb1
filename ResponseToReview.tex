...
\res{We have edited this section for clarity to better emphasize our main point that the \emph{Hopscotch} allele, which is known to produce a domesticated phenotype of reduced tiller number, is at higher than expected frequency in a subset of teosinte populations (the Jaliscan cluster of \emph{parviglumis}) and may play an adaptive role in certain environments encountered by teosinte.  
...
Based on these results we hypothesize that the \emph{Hopscotch} (\emph{i.e.}, the domesticated allele) allele at \emph{tb1} may play a role in the ecology of teosinte,  especially in high-density populations."}
