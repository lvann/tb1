...
We have clarified our sampling methodology on page 9, lines 188-206. Finally, plants were situated randomly in the greenhouse prior to genotyping, which effectively represents a randomized experimental design.}
...
\res{We have reported sample size information for all three genotypes on page 12 lines 281-284.} 
...
We have, however, added text to the conclusion (Page 15, lines 389-393) of this paper discussing their utility and the need for further work to elucidate the role of \emph{tb1} in branching architecture in teosinte:
...
\res{We have editied the introduction to include a more broad explanation of domestication and shade avoidance responses in plants. Edits can be seen on page 4, lines 24-38 and page 5, lines 65-70.}
...
\res{We have expanded on this concept in the introduction on page 4, lines 24-40: ``Domesticated crops and their wild progenitors provide an excellent system in which to study adaptation and genomic changes associated with human-mediated selection \citep{Ross-Ibarra2007}. 
...
\res{The sizes of amplicons are now mentioned explicitly in the Materials and Methods (page 5, lines 97-102) following primer sequences: 
...
\res{Thirty-two populations were included in these analyses, and we have edited the text to reflect this number on page 6, lines 108-109: ``These analyses only included populations ($n = 32$) in which eight or more chromosomes were sampled."}
...
\res{We have edited the text to clarify, page 9, lines 198-200 : ``Plants were watered three times a day with an automatic drip containing 10-20-10 fertilizer, which was supplemented with hand watering on extremely hot and dry days."}
